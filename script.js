const materias = {
  ...
  'SIS101': { nombre: 'Intro a Ingeniería de Sistemas', tipo: 'profesional', semestre: 1, requisitos: [] },
  'SIS103': { nombre: 'Intro a la Programación', tipo: 'basica', semestre: 1, requisitos: [] },
  ...
  'SIS110': { nombre: 'Contabilidad Financiera', tipo: 'profesional', semestre: 2, requisitos: ['UNI104'] },
  ...
  'SIS116': { nombre: 'Contabilidad de Costos', tipo: 'profesional', semestre: 3, requisitos: ['SIS110'] },
  ...
  'SIS122': { nombre: 'Gestión Financiera Operativa', tipo: 'profesional', semestre: 4, requisitos: ['SIS116'] },
  ...
  'SIS130': { nombre: 'Ingeniería Económica', tipo: 'profesional', semestre: 5, requisitos: ['SIS122', 'SIS124'] },
  ...
  'SIS152': { nombre: 'Taller de Culminación de Estudios', tipo: 'profesional', semestre: 9, requisitos: ['SIS146'] },
  'SIS153': { nombre: 'Administración de Proyectos', tipo: 'profesional', semestre: 9, requisitos: ['SIS148'] },

  // Optativas I y II
  'SIS1O1': { nombre: 'Inteligencia Artificial II', tipo: 'profesional', semestre: 9, requisitos: [] },
  'SIS1O2': { nombre: 'Seguridad de la Información', tipo: 'profesional', semestre: 9, requisitos: [] },
  'SIS103': { nombre: 'Planeación Estratégica', tipo: 'profesional', semestre: 9, requisitos: [] },
  'SIS104': { nombre: 'Gerencia Empresarial', tipo: 'profesional', semestre: 9, requisitos: [] },

  'SIS154': { nombre: 'Finalización de la Forma de Culminación de Estudios', tipo: 'profesional', semestre: 10, requisitos: ['SIS152'] }
};
